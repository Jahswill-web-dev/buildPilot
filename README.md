...
Idea Board is a small authenticated web application for capturing ideas, turning them into editable checklists, and tracking the next steps for each idea.
...
| **Idea detail (`/ideas/{idea}`)** | Editable idea details and checklist workflow |
